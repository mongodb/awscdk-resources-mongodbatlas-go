...
The go package is generated into the `github.com/cdktf/awscdk-resources-mongodbatlas-go` package.

```go

go get github.com/cdktf/awscdk-resources-mongodbatlas-go/mongodbatlas
