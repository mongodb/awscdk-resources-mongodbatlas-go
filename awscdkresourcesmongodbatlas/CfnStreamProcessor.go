...
func (j *jsiiProxy_CfnStreamProcessor) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnStreamProcessor) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnStreamProcessor) AttrStats() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStats",
...
func (j *jsiiProxy_CfnStreamProcessor) Props() *CfnStreamProcessorProps {
	var returns *CfnStreamProcessorProps
	_jsii_.Get(
		j,
		"props",
		&returns,
