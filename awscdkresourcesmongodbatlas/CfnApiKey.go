...
func (j *jsiiProxy_CfnApiKey) AttrAPIUserId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAPIUserId",
...
func (j *jsiiProxy_CfnApiKey) AttrPrivateKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPrivateKey",
...
func (j *jsiiProxy_CfnApiKey) AttrPublicKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPublicKey",
...
func (j *jsiiProxy_CfnApiKey) Props() *CfnApiKeyProps {
	var returns *CfnApiKeyProps
	_jsii_.Get(
		j,
		"props",
		&returns,
