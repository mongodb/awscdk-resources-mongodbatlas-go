...
func (j *jsiiProxy_CfnTrigger) Props() *CfnTriggerProps {
	var returns *CfnTriggerProps
	_jsii_.Get(
		j,
		"props",
		&returns,
...
func NewCfnTrigger(scope constructs.Construct, id *string, props *CfnTriggerProps) CfnTrigger {
	...
	if err := validateNewCfnTriggerParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTrigger_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTrigger_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrigger_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTrigger_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrigger_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTrigger_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTrigger) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrigger) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTrigger) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTrigger) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnTrigger) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrigger) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
