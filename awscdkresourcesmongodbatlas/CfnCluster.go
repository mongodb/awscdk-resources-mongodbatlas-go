...
func (j *jsiiProxy_CfnCluster) AttrCreatedDate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedDate",
...
func (j *jsiiProxy_CfnCluster) AttrMongoDBVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrMongoDBVersion",
...
func (j *jsiiProxy_CfnCluster) AttrStateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStateName",
...
func (j *jsiiProxy_CfnCluster) Props() *CfnClusterProps {
	var returns *CfnClusterProps
	_jsii_.Get(
		j,
		"props",
		&returns,
