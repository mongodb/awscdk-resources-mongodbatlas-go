...
func (j *jsiiProxy_CfnMaintenanceWindow) Props() *CfnMaintenanceWindowProps {
	var returns *CfnMaintenanceWindowProps
	_jsii_.Get(
		j,
		"props",
		&returns,
...
func CfnMaintenanceWindow_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnMaintenanceWindow_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
